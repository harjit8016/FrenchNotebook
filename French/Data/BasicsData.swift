...
enum BasicsData {
    ...
    static let alphabet: [AlphabetItem] = [
        ...
        AlphabetItem(letter: "E", frenchWord: "Éléphant", englishMeaning: "Elephant", phonetic: "uh · eh-lay-fahn", punjabiSound: "ਉ · ਏਲੇਫਾਂ", iconName: "pawprint.fill"),
        AlphabetItem(letter: "F", frenchWord: "Fleur", englishMeaning: "Flower", phonetic: "eff · fluhr", punjabiSound: "ਐਫ · ਫਲੂਖ਼", iconName: "leaf.fill"),
        AlphabetItem(letter: "G", frenchWord: "Gâteau", englishMeaning: "Cake", phonetic: "zheh · gah-toh", punjabiSound: "ਜ਼ੇ · ਗਾਤੋ", iconName: "cup.and.saucer.fill"),
        ...
        AlphabetItem(letter: "I", frenchWord: "Île", englishMeaning: "Island", phonetic: "ee · eel", punjabiSound: "ਈ · ਈਲ", iconName: "sun.haze.fill"),
        ...
        AlphabetItem(letter: "L", frenchWord: "Lune", englishMeaning: "Moon", phonetic: "ell · loon", punjabiSound: "ਐਲ · ਲੂਨ", iconName: "moon.fill"),
        ...
        AlphabetItem(letter: "O", frenchWord: "Oiseau", englishMeaning: "Bird", phonetic: "oh · wah-zoh", punjabiSound: "ਓ · ਵਾਜ਼ੋ", iconName: "leaf.fill"),
        ...
        AlphabetItem(letter: "R", frenchWord: "Règle", englishMeaning: "Ruler / Rule", phonetic: "ehr · reh-glə", punjabiSound: "ਐਖ਼ · ਰੈਗਲ", iconName: "ruler.fill"),
        AlphabetItem(letter: "S", frenchWord: "Soleil", englishMeaning: "Sun", phonetic: "ess · soh-lay", punjabiSound: "ਐਸ · ਸੋਲੇ", iconName: "sun.max.fill"),
        AlphabetItem(letter: "T", frenchWord: "Train", englishMeaning: "Train", phonetic: "teh · trahn", punjabiSound: "ਤੇ · ਤ੍ਰਾਂ", iconName: "tram.fill"),
        AlphabetItem(letter: "U", frenchWord: "Usine", englishMeaning: "Factory", phonetic: "oo · oo-zeen", punjabiSound: "ਊ · ਊਜ਼ੀਨ", iconName: "building.2.fill"),
        ...
        AlphabetItem(letter: "W", frenchWord: "Wagon", englishMeaning: "Wagon / Carriage", phonetic: "doo-bluh-veh · vah-gohn", punjabiSound: "ਦੂਬਲ-ਵੇ · ਵਾਗੋਂ", iconName: "tram.fill"),
        ...
        AlphabetItem(letter: "Z", frenchWord: "Zèbre", englishMeaning: "Zebra", phonetic: "zehd · zeh-brə", punjabiSound: "ਜ਼ੈਡ · ਜ਼ੇਬ੍ਰ", iconName: "pawprint.fill")
    ]
            ...
            categories: [
                BasicsCategory(
                    ...
                    items: [
                        ...
                        BasicsItem(french: "De rien", english: "You're welcome", phonetic: "duh-ryen", punjabiSound: "ਦੁ-ਰਿਆਂ", iconName: "checkmark.circle.fill"),
                        BasicsItem(french: "Pardon / Désolé", english: "Sorry / Excuse me", phonetic: "par-dohn / day-zoh-lay", punjabiSound: "ਪਾਰਦੋਂ / ਦੇਜ਼ੋਲੇ", iconName: "heart.fill", spokenText: "Pardon, Désolé")
                    ]
                ),
                BasicsCategory(
                    ...
                    items: [
                        ...
                        BasicsItem(french: "Onze, Douze, Treize, Quatorze, Quinze, Seize", english: "11 to 16", phonetic: "ohnz, dooz, trehz, kah-torz, kanz, sehz", punjabiSound: "ਓਂਜ਼, ਦੂਜ਼, ਤ੍ਰੈਜ਼, ਕਾਤੋਖ਼ਜ਼, ਕੈਂਜ਼, ਸੈਜ਼", iconName: "number.square.fill"),
                        ...
                        BasicsItem(french: "Quatre-vingt-dix (90)", english: "90 (4 × 20 + 10 = Quatre-vingt-dix)", phonetic: "katr-vahn-dees", punjabiSound: "ਕਾਤ੍ਰ-ਵੇਂ-ਦੀਸ", iconName: "plus.circle.fill", grammarNote: "90 is (4×20)+10. 99 is Quatre-vingt-dix-neuf!", spokenText: "Quatre-vingt-dix"),
                        BasicsItem(french: "Cent", english: "100", phonetic: "sahn", punjabiSound: "ਸਾਂ", iconName: "number.square.fill")
                    ]
                ),
                BasicsCategory(
            ...
            categories: [
                ...
                BasicsCategory(
                    ...
                    items: [
                        ...
                        BasicsItem(french: "C'est le 15 août", english: "It is August 15th (Date format: Le + Number + Month)", phonetic: "seh luh kanz oot", punjabiSound: "ਸੈ ਲੁ ਕੈਂਜ਼ ਊਤ", iconName: "calendar", grammarNote: "In French dates, always write 'Le' + Number + Month (e.g. Le 15 août). First day is 'Le premier'!")
                    ]
                ),
                BasicsCategory(
                    title: "Nature & Sky",
